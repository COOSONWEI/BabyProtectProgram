            ...
            VStack(alignment: .leading){
                ...
                HStack(alignment: .center){
                    Image(systemName: "heart.fill")
                        .resizable()
                        .frame(width: 10.10632, height: 9.66466)
                        .fixedSize()
                        .foregroundColor(.red)
...
struct HealthHeartView_Previews: PreviewProvider {
    static var previews: some View {
        HealthHeartView(rate: 70)
    }
}
